...
import io.gateways.server.enumuration.Status;
...
public class ServerApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo) {
		return args -> {
			...
			serverRepo.save(new Server(null, "192.168.1.21", "Microsoft 2008", "32 GB", "Web Server", "http:///Localhost:8080/server/image/server3/png", Status.SERVER_UP));
